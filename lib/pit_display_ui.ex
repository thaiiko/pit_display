defmodule PitDisplayUi do
  ...
  ### Server-Client Communication
      ...
      def handle_event("open_dialog", _params, socket) do
        socket = PitDisplayUi.LiveView.send_command(socket, "user-dialog", "open")
        {:noreply, socket}
      end
  ...
  defmacro __using__(_) do
    quote do
      import PitDisplayUi.Accordion
      import PitDisplayUi.Alert
      import PitDisplayUi.AlertDialog
      import PitDisplayUi.Avatar
      import PitDisplayUi.Badge
      import PitDisplayUi.Breadcrumb
      import PitDisplayUi.Button
      import PitDisplayUi.Card
      import PitDisplayUi.Chart
      import PitDisplayUi.Checkbox
      import PitDisplayUi.Collapsible
      import PitDisplayUi.Dialog
      import PitDisplayUi.DropdownMenu
      import PitDisplayUi.Form
      import PitDisplayUi.Helpers
      import PitDisplayUi.HoverCard
      import PitDisplayUi.Icon
      import PitDisplayUi.Input
      import PitDisplayUi.Label
      import PitDisplayUi.Menu
      import PitDisplayUi.Pagination
      import PitDisplayUi.Popover
      import PitDisplayUi.Progress
      import PitDisplayUi.RadioGroup
      import PitDisplayUi.ScrollArea
      import PitDisplayUi.Select
      import PitDisplayUi.Separator
      import PitDisplayUi.Sheet
      import PitDisplayUi.Sidebar
      import PitDisplayUi.Skeleton
      import PitDisplayUi.Slider
      import PitDisplayUi.Switch
      import PitDisplayUi.Table
      import PitDisplayUi.Tabs
      import PitDisplayUi.Textarea
      import PitDisplayUi.Toggle
      import PitDisplayUi.ToggleGroup
      import PitDisplayUi.Tooltip
    end
  end
end
